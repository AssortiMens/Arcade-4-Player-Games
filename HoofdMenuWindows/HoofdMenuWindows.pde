...
//      try {
//        try {
        String cmdString[] = {"cmd /c processing cli --sketch=\"Arcade-4-Player-Pacman/PCM\" --run",
                              "cmd /c processing cli --sketch=\"Arcade-4-Player-Pong/FPP\" --run",
                              "cmd /c processing cli --sketch=\"Brickwall-Demo/BrickWall\" --run",
                              "cmd /c processing cli --sketch=\"Gyruss-Demo/Gyruss\" --run"
                             };
