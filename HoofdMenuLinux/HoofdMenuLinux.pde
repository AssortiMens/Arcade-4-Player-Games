...
//      try {
//        try {
        String cmdString[] = {"sudo processing-4.3/processing-java --sketch=\"Arcade-4-Player-Games-kopie/Arcade-4-Player-Pacman/PCM\" --run",
                              "sudo processing-4.3/processing-java --sketch=\"Arcade-4-Player-Games-kopie/Arcade-4-Player-Pong/FPP\" --run"};
